      ...
      <div className="bg-[#161616] min-h-screen text-white font-quicksand p-20">
        <Table>
          ...
          <TableHeader className="mx-auto">
            <TableRow  className="bg-green-500 hover:bg-green-500 text-black">
          ...
          <TableFooter>
            <TableRow>
              <TableCell colSpan={3} className="bg-green-500 text-black">Total</TableCell>
              <TableCell className="text-right bg-green-500 text-black">$2,500.00</TableCell>
            </TableRow>
          </TableFooter>
        </Table>
      </div>
